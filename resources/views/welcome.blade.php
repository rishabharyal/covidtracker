...
@section('content')
    <div class="container">
        ...
        <h4>This platform tracks the infected people, their locations and recently visited places, which helps us to analyze its spread and control.</h4>
        <ul>
